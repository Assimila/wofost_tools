...
from era2cabo import do_conversion_single
...
print (bl_lat, bl_lon, tr_lat, tr_lon)

for year in years:

    if manual_data_point == None:

        file_name = run_handle+'_era5_cabo_data_%s.nc'%year,
    ...
    if manual_data_point == None:
        ...
        data_file = manual_data_point

    do_conversion_single(data_file,sites_lats,sites_lons,location_tz,run_handle_list)
